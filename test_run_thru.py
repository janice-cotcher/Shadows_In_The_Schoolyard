...
#             project.act_three(project.cache)
...
Chant: Away Tsathoggua!"""
    ...
    with patch("builtins.input", side_effect=input_generator(test_input)):
...
#     Chant: Away Tsathoggua!"""
#     index = "Examine a diary"
#     action_room = MockRoom("Hawkins Factory", "Secret Room", items="a diary", item_description="a diary with pages filled with strange writings")

#     with patch("builtins.input", side_effect=input_generator(test_input)):
#         result = project.decoded(index, action_room)
#         print(f"Decoded function returned: {result}")
